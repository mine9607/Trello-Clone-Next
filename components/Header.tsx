...
import trelloLogo from "@/public/images/trello-logo-gradient-blue.svg";
  ...
  return (
    <header className="">
      <div className="flex flex-col md:flex-row items-center p-5 bg-gray-500/10 rounded-b-2xl">
        <div className="absolute top-0 left-0 w-full h-96 bg-gradient-to-br from-[#82d0ff] to-[#0055d1] rounded-3xl filter blur-3xl opacity-75 -z-50">
          hey
        </div>
        ...
        <div className="flex items-center space-x-5 flex-1 justify-end w-full">
          ...
          <Avatar name="Brian Miner" round color="#0055D1" size="50" />
        </div>
      </div>
